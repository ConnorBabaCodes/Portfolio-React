    ...
    <header>
      <nav>
        ...
        <div className="nav-buttons">
          <ul>
            <li className="hide">
              <a className="nav-hover hide" href="#projects">
                Projects
              </a>
            </li>
            <li className="hide">
              <a className="nav-hover hide" href="#testimonials">
                Testimonials
              </a>
            </li>
            <li className="hide">
              <a className="nav-hover hide" href="#contact">
                Contact
              </a>
            </li>
            <li>
              <a className="hide" href={Resume} target="_blank">
                Resume
              </a>
            </li>
