...
export default function Projects() {
    const projectElements = projectData.map(project => {
        return <div className="project">
           <a href={project.demo ? project.demo : project.github} aria-label={`${project.name}`} target="_blank"><img src={project.smallimg} srcSet={`${project.smallimg} 868w, ${project.img} 1200w`} alt={`${project.name} cover image`}/></a>
                <h2>
                    {project.name}
                    </h2>
                <p>
